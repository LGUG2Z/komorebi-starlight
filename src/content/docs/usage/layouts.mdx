...
You can customize the split ratios for various layouts using `column_ratios` and `row_ratios` in the <KomorebiConfigPlatformLink command="workspaceconfig-layout_options" text="layout_options"/> configuration.
